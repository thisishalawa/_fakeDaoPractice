...
class FakeQuoteRepository private constructor(private val quoteDao: FakeQuoteDao) {
    ...
    companion object {
        ...
        @Volatile
        private var instance: FakeQuoteRepository? = null

        fun getInstance(quoteDao: FakeQuoteDao) =
            instance ?: synchronized(this) {
                instance ?: FakeQuoteRepository(quoteDao).also { instance = it }
            }
    }
